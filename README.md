# Monopoly Game Simulation using C++ 🎲

This project is a console-based (CLI) simulation of the classic board game **Monopoly**. It was developed as a final assignment for the Data Structures course to demonstrate an understanding of **Object-Oriented Programming (OOP)** and the implementation of **Data Structures**.
...
* 📄 **Full Paper.pdf** (In-depth analysis)
* 📊 **Presentation Slides.pdf** (Architecture & Logic Diagrams)
